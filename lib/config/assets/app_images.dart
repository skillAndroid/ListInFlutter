class AppImages {
  ...
  static const String wFormat = '.jpg';

  static const appLogo = '${basePath}list_in$format';

  // categories images
  static const auto = '${basePath}auto$format'; //
  static const animals = '${basePath}animals$format'; //
  static const closes = '${basePath}closes$format'; //
  static const electronics = '${basePath}electronics.jpg'; //
  static const forchildren = '${basePath}forchildren$format'; //
  static const garden = '${basePath}garden$format'; //
  static const household = '${basePath}household.jpg'; //
  static const realestate = '${basePath}realestate$format'; //
