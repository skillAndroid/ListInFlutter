...
class AppColors {
  ...
  static const primaryLight2 =
      Color.fromARGB(255, 143, 234, 149); // Light green for secondary elements
  ...
  static const bgColor = Color.fromARGB(255, 254, 254, 254);
  ...
  static const containerColor = Color.fromARGB(255, 244, 244, 244);
  static const containerColorDark = Color.fromARGB(255, 27, 27, 27);
  ...
  static const lighterGray = Color.fromARGB(255, 233, 233, 233);
