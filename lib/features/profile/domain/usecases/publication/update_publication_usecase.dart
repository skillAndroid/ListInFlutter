...
class UpdatePostUseCase extends UseCase2<GetPublicationEntity, UpdatePostParams> {
  final UserPublicationsRepository repository;

  UpdatePostUseCase(this.repository);

  @override
  Future<Either<Failure, GetPublicationEntity>> call({UpdatePostParams? params}) async {
    if (params == null) {
